...
def test_validate_drops_uncited_and_empty_items():
    ...
    result = {
        "intros": [],
        "next_steps": [
            {"owner": {"name": "F", "email": "", "company": ""}, "owner_side": "them",
             "action": "Send the IC memo", "due": "", "quote": "I'll send the IC memo over tomorrow.",
             "confidence": "high"},
            {"owner": {"name": "F", "email": "", "company": ""}, "owner_side": "them",
             "action": "Invented", "due": "", "quote": "This sentence is not in the email.", "confidence": "high"},
        ],
        "deal_mentions": [
            {"company_name": "", "company_domain": "", "stage": "", "round_size_usd": 0, "summary": "",
             "quote": "Acme is raising", "confidence": "low"},
        ],
    }
